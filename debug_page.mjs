...
await page.waitForSelector('.detail-timeline', { timeout: 15000 }).catch(() => {})
...
const m = await page.evaluate(() => {
  ...
  if (!timeline || !stageInfo) return { error: 'elements not found', hasTimeline: !!timeline, hasStageInfo: !!stageInfo }
