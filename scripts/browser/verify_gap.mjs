...
if ((await firstRow.count()) > 0) {
  ...
  await page
    .waitForSelector('.detail-timeline', { timeout: 10000 })
    .catch(() => {})
...
if ((await dialog.count()) > 0) {
  await dialog.screenshot({ path: 'tests/screenshots/timeline_gap_fixed.png' })
  console.log('截图: tests/screenshots/timeline_gap_fixed.png')
}
